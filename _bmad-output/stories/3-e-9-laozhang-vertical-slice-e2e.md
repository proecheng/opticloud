...
- 2026-05-24 - On the clean base branch, Playwright needed `PLAYWRIGHT_PYTHON` pointed at the workspace venv and the config needed a plain object export to avoid config wrapper issues.
