...
- 2026-05-29 - Rebased onto latest `main`, removed stale branch drift, applied ruff cleanup for an unused import, and re-ran focused/adjacent/full/static validation successfully.
...
- Rebase validation on 2026-05-29 passed after ruff removed one unused test import; no production behavior changed.
...
- 2026-05-29 - Rebased branch onto latest `main`, applied ruff unused-import cleanup, and revalidated focused/adjacent/full/static checks.
