...
TRANSITIONS: Final[tuple[Transition, ...]] = (
    ...
    Transition(State.RESERVED, State.CHARGED, "service_success", 2_000, 3, Compensation.REFUND_AUTO, 10),
    ...
    Transition(State.CHARGED, State.COMPLETED, "outbox_delivered", 500, 1_000_000, Compensation.RETRY_OUTBOX, 3),
    Transition(State.CHARGED, State.ROLLED_BACK, "downstream_reject_late", 1_000, 1, Compensation.ESCALATE_OPS, 10),
)
