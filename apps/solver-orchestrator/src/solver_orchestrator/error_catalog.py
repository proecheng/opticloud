...
ERROR_CATALOG: dict[str, ErrorCatalogEntry] = {
    ...
    "invalid_execution_mode": _entry(
        ...
        detail_en="{detail}",
        detail_zh="{detail}",
        constraint="mode must be one of: sync, async, teaching",
    ...
    "invalid_benchmark_library_option": _entry(
        "invalid_benchmark_library_option",
        slug="invalid_benchmark_library_option",
        status=400,
        title_en="Invalid Benchmark Library Option",
        title_zh="经典算例库选项无效",
        detail_en="{detail}",
        detail_zh="{detail}",
        constraint="benchmark library options must reference an eligible published optimization benchmark",
        remediation_hint_key="errors.400.invalid_benchmark_library_option",
        next_action_url="https://api.opticloud.cn/v1/benchmark-library",
        default_field_path="options.benchmark_id",
    ),
    ...
    "source_task_not_completed": _entry(
        "source_task_not_completed",
        slug="source_task_not_completed",
        status=422,
        title_en="Source Task Not Completed",
        title_zh="源任务尚未完成",
        detail_en="{detail}",
        detail_zh="{detail}",
        constraint="source task status must be completed",
        remediation_hint_key="errors.422.source_task_not_completed",
        next_action_url=f"{DOCS_BASE_URL}/job-templates",
        default_field_path="source_id",
    ),
...
TITLE_TO_KEY: dict[str, str] = {
    ...
    "Invalid Benchmark Library Option": "invalid_benchmark_library_option",
    ...
    "Source Task Not Completed": "source_task_not_completed",
